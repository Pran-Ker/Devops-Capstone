...
The project consists of us building an API that behaves as a database client. The postegress Database will be completely secure insde the cluster. To query information POST requests will be sent to the API that will excute in the database and give the desired results.
---
...
More information: [here](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/)
